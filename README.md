...
|---|---|---|
| **[VulnFuse](https://github.com/CAOShurong/vulnfuse)** | Correlates duplicate scanner findings, explains every match or blocker, and compares runs as new, updated, unchanged, or absent without uploading reports. | [Browser workbench](https://caoshurong.github.io/vulnfuse/) · [v0.2.0](https://github.com/CAOShurong/vulnfuse/releases/tag/v0.2.0) |
