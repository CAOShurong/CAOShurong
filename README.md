...
| --- | --- | --- |
| **[ResearchBench](https://github.com/CAOShurong/researchbench)** | A comprehensive benchmark for evaluating AI academic and research capabilities: paper comprehension, idea generation, literature synthesis, experimental design, peer review, code reproduction, and open question identification. Fills a gap no existing benchmark covers. | [v0.1.0](https://github.com/CAOShurong/researchbench/releases/tag/v0.1.0) · [background research](https://github.com/CAOShurong/researchbench#why) · [7 task categories](https://github.com/CAOShurong/researchbench#task-categories) |
