...
- **Fix things where I am a user.** 28 accepted pull requests across 15
  upstream repositories — Apache Magpie, eLabFTW, TheELNFileFormat, SampleDB,
  Astropy, CycloneDX, Keycloak, Plotly.js, rclone, Syft, tox, regl-line2d,
